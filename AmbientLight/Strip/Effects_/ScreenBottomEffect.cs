...
{
	class ScreenBottomEffect : Effect
	{
		...
		public ScreenBottomEffect(Logger logger, VirtualStrip strip, int maxFPS, ColorManager foreColorManager, ColorManager backColorManager)
		{
			this.logger = new Logger(logger);
			this.logger.AddLevel("ScreenBottomEffect");
